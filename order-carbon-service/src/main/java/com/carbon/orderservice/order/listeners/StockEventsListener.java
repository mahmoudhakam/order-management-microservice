...
import com.carbon.orderservice.order.listeners.events.StockConfirmationEvent;
import com.carbon.orderservice.order.listeners.events.StockRejectionEvent;
...
import static com.carbon.orderservice.common.configs.KafkaConfig.ORDER_STOCK_CONFIRM_TOPIC;
import static com.carbon.orderservice.common.configs.KafkaConfig.ORDER_STOCK_REJECT_TOPIC;
import static com.carbon.orderservice.order.domain.OrderStatus.CANCELLED_OUT_OF_STOCK;
import static com.carbon.orderservice.order.domain.OrderStatus.RESERVED_PROCESSING_PAYMENT;
